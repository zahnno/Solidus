...
ActiveRecord::Schema.define(version: 20160527193120) do
  ...
  add_index "attribute_maps", ["attribution_id"], name: "index_attribute_maps_on_attribution_id"
  add_index "attribute_maps", ["parent_attribute_id"], name: "index_attribute_maps_on_parent_attribute_id"
